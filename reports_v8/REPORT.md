...
| Method | Path | Role | Latency |
| :--- | :--- | :--- | :--- |
| GET | /users | ADMIN | 12ms |
| GET | /users | OPERATOR | 1ms |
| GET | /users | READONLY | 1ms |
| POST | /users | ADMIN | 1ms |
| POST | /users | OPERATOR | 1ms |
